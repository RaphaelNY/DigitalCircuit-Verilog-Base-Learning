...
REM
REM Generated by Vivado on Fri Nov 24 15:06:30 +0800 2023
...
call xsim  First_M_test_behav -key {Behavioral:sim_1:Functional:First_M_test} -tclbatch First_M_test.tcl -log simulate.log
